========================================================================
   APLICACIÓN: PilasColas Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PilasColas.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación PilasColas.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado PilasColas.pch y un archivo de tipos 
